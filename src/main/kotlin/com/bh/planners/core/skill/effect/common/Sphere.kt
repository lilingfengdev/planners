 ...
 * @author Zoyn
 */
class Sphere(override var origin: Location, var sample: Int, var  radius: Double, spawner: ParticleSpawner) : ParticleObj(
    spawner
) {
    /**
     * 黄金角度 约等于137.5度
     */
    private val phi = Math.PI * (3.0 - Math.sqrt(5.0))
