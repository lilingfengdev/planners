...
class ProxyDamagePreEvent(damager: Entity, entity: Entity, cause: EntityDamageEvent.DamageCause?, damage: Double) : AbstractProxyDamageEvent(damager, entity, cause, damage) {
    ...
    companion object {
        ...
        fun e(ope: OptionalEvent) {
            ...
            if (e.priorityEnum == PriorityEnum.PRE) {
                ...
                val damageEvent = ProxyDamagePreEvent(damager, memory.injured, memory.event.bukkitCause, memory.totalDamage)
