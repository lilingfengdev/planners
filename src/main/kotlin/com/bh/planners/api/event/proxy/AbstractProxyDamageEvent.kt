...
abstract class AbstractProxyDamageEvent(val damager: Entity, val entity: Entity, val cause: EntityDamageEvent.DamageCause?, var damage: Double) : BukkitProxyEvent() {
